...
<link rel="stylesheet" href="<?php echo base_url("assets/css/ermetal.css");?>" />

<script src="<?php echo base_url("assets/js/ermetal.js"); ?>" ></script>
...
<script type="text/javascript" language="javascript">
    ...
    class Map {
        constructor() {
            ...
            }).setView([40.2707422,29.0623625], 50)
            ...
            */
            ...
            if (isExist && (isExist._latlng.lat != lat || isExist._latlng.lng != lng)) {
                ...
                let marker = new L.Marker([lat, lng], {
                    name: personName,
                    //icon: forkliftIcon, //identifer olarak kullanıyorum. daha mantıklı eşsiz bir değişken kullanılabilir
                }).bindPopup(personName).addTo(this.markers)
    ...
    jQuery(document).ready(function($) {
        ...
        setInterval(function() {
            ...
            $.get("<?php echo base_url('ermetal/get_ermetal'); ?>", function(data, status) {
