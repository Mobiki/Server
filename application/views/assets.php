    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary"><button type="button" id="btn_add_asset" data-toggle='modal' data-target='#addAssetModal' class="btn btn-primary btn-sm">Add Asset</button></h6>
            </div>
            <div class="card-body">
...
<div class="modal fade bd-modal-lg" tabindex="-1" role="dialog" id="addAssetModal" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="etype_id" name="type_id">
                                    ...
                                    <?php foreach (@$asset_type as $key => $dtvalue) { ?>
