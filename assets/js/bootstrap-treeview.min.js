!(function(a, b, c, d) {
  ...
  (f.settings = {
    ...
    uncheckedIcon: "fa fa-chevron-down",
  ...
  (g.prototype.init = function(b) {
            ...
            f.append(
              d.options.enableLinks
                ? a(d.template.link)
                    .attr("href", e.href)
                    .append(e.text)
                : e.text+' <button id="btn_add" onclick="btnadd('+e.id+','+e.elementId+')" data-id="'+e.id+'" class="btn btn-success btn-sm" style="margin-left: 15px;">+</button><button id="btn-delete" onclick="btndelete('+e.id+')" data-id="'+e.id+'" class="btn btn-danger btn-sm" style="margin-left: 15px;">-</button>'//yazıların yazıldığı yer
            ),
            d.options.showTags &&
              e.tags &&
    ...
    (g.prototype.template = {
      ...
      icon: '<i class="icon fa"></i>',
      link: '<a href="#" style="color:inherit;"></a>',
      badge: '<span class="badge"></span>'
    }),
    (g.prototype.css =
      ".treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:15px;margin-right:10px}.treeview i.icon{width:15px;margin-right:5px}.treeview .node-disabled{color:silver;cursor:pointer}"),
    ...
    (g.prototype.clearSearch = function(b) {
      ...
      var c = a.each(this.findNodes("true", "g", "searchResult"), function(
        a,
        b
      ) {
        b.searchResult = !1;
